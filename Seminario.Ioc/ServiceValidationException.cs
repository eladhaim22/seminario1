...
namespace Seminario.Ioc
{
	...
	public class ServiceValidationException : ServiceException
	{
		...
		/// <param name="validationResult">The validation result that is the cause of the current exception.</param>
		/// <param name="message">The error message that explains the reason for the exception.</param>
		public ServiceValidationException(ValidationResult validationResult, string message)
		...
		/// <param name="message">The error message that explains the reason for the exception.</param>
		/// <param name="innerException">The exception that is the cause of the current exception.</param>
		public ServiceValidationException(ValidationResult validationResult, string message, Exception innerException)
		...
		/// <summary>Initializes a new instance of the <see cref="ServiceValidationException"/> class with serialized data.</summary>
